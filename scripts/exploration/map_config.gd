...
#   Fase 1: arena aberta, pilares, sala-chokepoint do boss, Erva da Vida, 5 inimigos.
#   Fase 2: mesma topologia encharcada de fogo, 5 inimigos (Boitatá).
#   Fase 3: "Ventre da Mata" — corredores estreitos, fog of war, 5 inimigos (Curupira).
#   Fase 4: casa em chamas — fogo denso, 5 inimigos (Saci).
#
...
# Composição dos inimigos comuns: caçador + bruxo, 2/2 por paridade.
#   Fase 1: apenas caçadores (4) — sem bruxo, introdução suave do combate.
#   Fases ímpares (3): 2 bruxos + 2 caçadores.
#   Fases pares   (2, 4): 2 caçadores + 2 bruxos.
# Total = 4 comuns; com o boss, fecha os 5 de enemy_count.
