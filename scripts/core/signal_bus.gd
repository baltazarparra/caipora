...
# ─── Enums ─────────────────────────────────────────
enum Screen { MAIN_MENU, EXPLORATION, ARENA, GAME_OVER, WIN, HUB, EXPLORATION_PHASE2, ARENA_PHASE2, EXPLORATION_PHASE3, ARENA_PHASE3, EXPLORATION_PHASE4, ARENA_PHASE4, ENDING, EXPLORATION_PHASE5, ARENA_PHASE5, FINAL_CHOICE, ENDING_SACRIFICE, INITIALS }
